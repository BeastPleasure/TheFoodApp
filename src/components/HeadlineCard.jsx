    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
        ...
        <div className='rounded-xl relative'>
            ...
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                ...
                <button className='border-white bg-white text-black mx-2 absolute bottom-4'> New Partners! </button>
        ...
        <div className='rounded-xl relative'>
            ...
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                ...
                <p className='font-bold text-2xl px-2 pt-4'> We Deliver Dessets Too </p>
            ...
            <img className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl' src='https://images.pexels.com/photos/769289/pexels-photo-769289.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' alt=''/>
